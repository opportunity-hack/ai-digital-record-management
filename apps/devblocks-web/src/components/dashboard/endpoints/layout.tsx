        ...
        <span className="flex w-full flex-row items-center rounded border-2 border-pt bg-white p-2 font-mono text-base font-black shadow-[0rem_0.25rem_var(--color-primary-text)]">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-sans font-semibold">
              Search for documents by entering text into the search bar below and then clicking on <span className="rounded bg-pc p-1 px-2 font-mono text-sm text-white">SEARCH!</span>.
            </span>
          </div>
        </span>
