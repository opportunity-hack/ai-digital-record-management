  ...
  return (
    <div className="flex h-full flex-col justify-between space-y-2  rounded border-2 border-pt bg-white px-4 py-2 shadow-[0rem_0.25rem_var(--color-primary-text)]">
      <span className="flex flex-col space-y-2">
        ...
        <DashboardItem Icon={SearchIcon} title="Search" href={routes.dashboard_search} depth={3} />
        <DashboardItem Icon={UploadIcon} title="Upload" href={routes.dashboard_upload} depth={3} />
        {/* <hr className="" /> */}
